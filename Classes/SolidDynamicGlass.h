...
public:
    ...
    static DynamicGlass* create(const cocos2d::Color4F& color = cocos2d::Color4F::MAGENTA);
...
protected:
    ...
    virtual bool init(const cocos2d::Color4F& color);
    DynamicGlass();
    virtual ~DynamicGlass();

    static void prepare(); //初始化shared vao/vbo...
    static bool _prepared;
    static GLuint _vao;
    static GLuint _vbo;
    static float _width;
    static float _height;
    static GLsizei _wNumber;
    static GLsizei _hNumber;
    static GLsizei _count;
    static DynamicGlassVertexFormat* _data;
    static void fillVertexData();
